...
if __name__ == '__main__':
    ...
    #print(data)
    # pic = cv2.imread("E:\MyTennis\\tennisProject\scripts\data_pic\\test.jpg")
    # pic=cv2.imread("yes.png")
    test=[]
    counter = 0
    stage = None
    dir_path = "E:\MyTennis\\tennisProject\scripts\data_pic\\test"
    ...
    for file in files:
        ...
        with mp_pose.Pose(min_detection_confidence=0.3, min_tracking_confidence=0.8) as pose:
            ...
            try:
                ...
                test.append(
                    [langle, rangle, lsangle, rsangle, lhangle, rhangle, lkangle, rkangle,1])
                print(test)
    ...
    # column = ["langle", "rangle", "lsangle", "rsangle", "lhangle", "rhangle", "lkangle", "rkangle", 'class']  # 列表头名称,11个特征1个分类
